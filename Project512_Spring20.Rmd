...
param_list <- list(mtry = c(4,18), 
ntree = c(500,750,1000,2500,5000,10000))
...
plot_min_depth_distribution(min_depth_distribution(model_list[1]))

plot_min_depth_distribution(min_depth_distribution(model_list[2]))
```
