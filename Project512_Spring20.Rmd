...
ntree = c(seq(1,10),seq(20,1000,10)))
...
plot_testerrorrandom <- ggplot(data = decision_df %>% filter(ntree > 1), aes(x = ntree, y = test_mse, color = as.factor(mtry))) + 
  geom_line(size = 1.1) +
  ylab("Test MSE") + 
